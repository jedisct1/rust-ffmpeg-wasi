...
pub const LIBAVFILTER_VERSION_MINOR: u32 = 2;
...
pub const AVFILTER_AUTO_CONVERT_ALL: _bindgen_ty_2 = 0;
#[doc = "< all automatic conversions disabled"]
pub const AVFILTER_AUTO_CONVERT_NONE: _bindgen_ty_2 = -1;
...
impl Default for AVFilterParams {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
impl Default for AVFilterGraphSegment {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
